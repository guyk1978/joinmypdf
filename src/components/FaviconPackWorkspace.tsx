...
export function FaviconPackWorkspace({ tool, slug }: FaviconPackWorkspaceProps) {
  ...
  const labels = useMemo<FaviconPackLabels>(
    () => ({
      ...
      includesManifest: t("includesManifest"),
      ...
      formatPreviewTitle: t("formatPreviewTitle"),
      formatPreviewHint: t("formatPreviewHint"),
      browserTabLabel: t("browserTabLabel"),
      iosHomeScreenLabel: t("iosHomeScreenLabel"),
      androidAppIconLabel: t("androidAppIconLabel"),
      windowsTaskbarLabel: t("windowsTaskbarLabel"),
      defaultSiteTitle: t("defaultSiteTitle"),
      privacyBadgeWaiting: t("privacyBadgeWaiting"),
      privacyBadgeLocal: t("privacyBadgeLocal"),
      autoFitBadge: t("autoFitBadge"),
      autoFitBadgeSquare: t("autoFitBadgeSquare"),
      consistencyTitle: t("consistencyTitle"),
      consistencyHint: t("consistencyHint"),
      consistencyPass: t("consistencyPass"),
      consistencyWarning: (upscale, shortSide, recommended) =>
        t("consistencyWarning", { upscale, shortSide, recommended }),

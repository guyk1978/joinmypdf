...
export function SiteHeader() {
  ...
  return (
    <header className="site-header fixed top-0 z-50 h-12 w-full overflow-visible border-b border-neutral-300 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900">

...
export function TransparentFaviconWorkspace({ tool, slug }: TransparentFaviconWorkspaceProps) {
  ...
  const labels = useMemo<TransparentFaviconLabels>(
    () => ({
      ...
      checkerboardPreviewLabel: t("checkerboardPreviewLabel"),
      checkerboardPreviewHint: t("checkerboardPreviewHint"),
      checkerboardLegend: t("checkerboardLegend"),
      securityStatusTitle: t("securityStatusTitle"),
      securityStatusWaiting: t("securityStatusWaiting"),
      securityStatusLocal: t("securityStatusLocal"),
      formatAutoSelectPrompt: (color) => t("autoSelectPrompt", { color }),
      autoSelectConfirm: t("autoSelectConfirm"),
      autoSelectDismiss: t("autoSelectDismiss"),
      exportSettingsLabel: t("exportSettingsLabel"),
      exportSettingsHint: t("exportSettingsHint"),
      formatExportSize: (key) => t(`exportSizes.${key}` as "exportSizes.native"),
      browserMockup: {
        title: t("browserMockupTitle"),
        hint: t("browserMockupHint"),
        lightMode: t("browserMockupLight"),
        darkMode: t("browserMockupDark"),
      },
    }),
    [t],
  );

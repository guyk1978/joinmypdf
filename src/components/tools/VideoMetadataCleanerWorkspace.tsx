...
export function VideoMetadataCleanerWorkspace({ tool, slug }: VideoMetadataCleanerWorkspaceProps) {
  ...
  const labels = useMemo<VideoMetadataCleanerLabels>(
    () => ({
      ...
      fieldModificationTime: t("fieldModificationTime"),
      fieldDevice: t("fieldDevice"),
      fieldDeviceMake: t("fieldDeviceMake"),
      fieldDeviceModel: t("fieldDeviceModel"),
      fieldGps: t("fieldGps"),
      fieldDate: t("fieldDate"),
      fieldEncoder: t("fieldEncoder"),
      fieldComment: t("fieldComment"),
      fieldTitle: t("fieldTitle"),
      fieldArtist: t("fieldArtist"),
      fieldAlbum: t("fieldAlbum"),
      fieldSoftware: t("fieldSoftware"),
      fieldFormat: t("fieldFormat"),
      fieldCopyright: t("fieldCopyright"),
      fieldOther: t("fieldOther"),

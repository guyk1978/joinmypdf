...
import { getTimelineTemplateBySlug, TIMELINE_TEMPLATE_PROFILES } from "@/lib/timeline/templates";
...
export function generateStaticParams() {
  return routing.locales.flatMap((locale) =>
    TIMELINE_TEMPLATE_PROFILES.map((profile) => ({ locale, slug: profile.slug })),
  );
}

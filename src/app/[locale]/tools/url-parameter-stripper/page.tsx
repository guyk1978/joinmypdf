...
const SLUG = "url-parameter-stripper";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "UrlParameterStripperPage" });
...
export default async function UrlParameterStripperPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const t = await getTranslations("UrlParameterStripperPage");

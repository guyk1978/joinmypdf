...
const SLUG = "add-page-numbers-online";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "AddPageNumbersOnlinePage" });
...
export default async function AddPageNumbersOnlinePage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const t = await getTranslations("AddPageNumbersOnlinePage");
      ...
      <AppPageShell mainClassName={productPageMainClassName}>
        <div className="home-minimal-layout home-minimal-layout--directory tools-directory-page mx-auto w-full max-w-7xl px-4 md:px-6">
          ...
          <section
            ...
            aria-labelledby="add-page-numbers-online-related"
          >
            <h2
              id="add-page-numbers-online-related"

...
const ARTICLE_SECTIONS = ["howToUse", "screenVsPrint", "metadata", "privacy"] as const;
    ...
    <>
      ...
      <AppPageShell mainClassName={productPageMainClassName}>
        <div className="home-minimal-layout home-minimal-layout--directory tools-directory-page mx-auto w-full max-w-7xl px-4 md:px-6">
          ...
          <article className="border-b border-[#262626] py-10" aria-labelledby="image-dpi-converter-article">
            <h2
              id="image-dpi-converter-article"
            ...
            {ARTICLE_SECTIONS.map((section) => {
              ...
              return (
                <section
                  ...
                  aria-labelledby={`image-dpi-converter-article-${section}`}
                >
                  <h3
                    id={`image-dpi-converter-article-${section}`}

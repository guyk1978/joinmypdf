...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "PngToPdfFastPage" });
...
export default async function PngToPdfFastPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const t = await getTranslations("PngToPdfFastPage");
      ...
      <AppPageShell mainClassName={productPageMainClassName}>
        <div className="home-minimal-layout home-minimal-layout--directory tools-directory-page page-container">
          ...
          <section
            ...
            aria-labelledby="png-to-pdf-fast-related"
          >
            <h2
              id="png-to-pdf-fast-related"

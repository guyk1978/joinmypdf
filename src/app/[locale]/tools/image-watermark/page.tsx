...
const ARTICLE_SECTIONS = ["howToUse", "copyright", "logoText", "privacy"] as const;
    ...
    <>
      ...
      <AppPageShell mainClassName={productPageMainClassName}>
        <div className="home-minimal-layout home-minimal-layout--directory tools-directory-page mx-auto w-full max-w-7xl px-4 md:px-6">
          ...
          <article className="border-b border-[#262626] py-10" aria-labelledby="image-watermark-article">
            <h2
              id="image-watermark-article"
            ...
            {ARTICLE_SECTIONS.map((section) => {
              ...
              return (
                <section
                  ...
                  aria-labelledby={`image-watermark-article-${section}`}
                >
                  <h3
                    id={`image-watermark-article-${section}`}

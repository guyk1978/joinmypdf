...
export default async function PdfToPngFastPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const t = await getTranslations("PdfToPngFastPage");
      ...
      <AppPageShell mainClassName={productPageMainClassName}>
        <div className="home-minimal-layout home-minimal-layout--directory tools-directory-page page-container">
          ...
          <section
            ...
            aria-labelledby="pdf-to-png-fast-related"
          >
            <h2
              id="pdf-to-png-fast-related"

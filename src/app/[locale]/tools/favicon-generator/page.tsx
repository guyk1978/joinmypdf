...
const ARTICLE_SECTIONS = ["howToUse", "brand", "htmlHead", "privacy"] as const;
...
export default async function FaviconGeneratorPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const t = await getTranslations("FaviconGeneratorPage");
    ...
    <>
      ...
      <AppPageShell mainClassName={productPageMainClassName}>
        <div className="home-minimal-layout home-minimal-layout--directory tools-directory-page mx-auto w-full max-w-7xl px-4 md:px-6">
          ...
          <article className="border-b border-[#262626] py-10" aria-labelledby="favicon-generator-article">
            <h2
              id="favicon-generator-article"
            ...
            {ARTICLE_SECTIONS.map((section) => {
              ...
              return (
                <section
                  ...
                  aria-labelledby={`favicon-generator-article-${section}`}
                >
                  <h3
                    id={`favicon-generator-article-${section}`}

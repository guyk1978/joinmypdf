...
const ARTICLE_SECTIONS = ["extractAudio", "audioFormats", "localFirst"] as const;
      ...
      <AppPageShell mainClassName={productPageMainClassName}>
        <div className="home-minimal-layout home-minimal-layout--directory tools-directory-page mx-auto w-full max-w-7xl px-4 md:px-6">
          ...
          <article
            ...
            aria-labelledby="video-to-mp3-article"
          >
            <h2
              id="video-to-mp3-article"
            ...
            {ARTICLE_SECTIONS.map((section) => {
              ...
              return (
                <section
                  ...
                  aria-labelledby={`video-to-mp3-article-${section}`}
                >
                  <h3
                    id={`video-to-mp3-article-${section}`}

...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "PngToPdfInstantPage" });
...
export default async function PngToPdfInstantPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const t = await getTranslations("PngToPdfInstantPage");
...
<section className="border-b border-[#262626] pb-8" aria-label={t("title")}>
          ...
          <section
            ...
            aria-labelledby="png-to-pdf-instant-related"
          >
            <h2
              id="png-to-pdf-instant-related"

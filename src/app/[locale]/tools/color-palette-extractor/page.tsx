...
const SLUG = "color-palette-extractor";
...
export default async function ColorPaletteExtractorPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const t = await getTranslations("ColorPaletteExtractorPage");

...
export default async function PdfEditorPage({ params }: PageProps) {
  ...
  const t = await getTranslations("PdfEditorPage");
    ...
    <>
      <JsonLd
        data={webApplicationLd({
          ...
          featureList: [
            t("schemaFeatureEdit"),
            t("schemaFeatureOcr"),
            t("schemaFeatureRichText"),
            t("schemaFeatureLocal"),
            t("schemaFeatureDownload"),
          ],
      ...
      <AppPageShell mainClassName={productPageMainClassName}>
        <div className="home-minimal-layout home-minimal-layout--directory tools-directory-page mx-auto w-full max-w-7xl px-4 md:px-6">
          ...
          <article className="border-b border-[#262626] py-10" aria-labelledby="pdf-editor-article">
            <h2
              id="pdf-editor-article"
            ...
            {ARTICLE_SECTIONS.map((section) => {
              ...
              return (
                <section
                  ...
                  aria-labelledby={`pdf-editor-article-${section}`}
                >
                  <h3
                    id={`pdf-editor-article-${section}`}

...
const ARTICLE_SECTIONS = ["whyRemove", "privacyRisks", "protectLocation"] as const;
      ...
      <AppPageShell mainClassName={productPageMainClassName}>
        <div className="home-minimal-layout home-minimal-layout--directory tools-directory-page mx-auto w-full max-w-7xl px-4 md:px-6">
          ...
          <article
            ...
            aria-labelledby="video-metadata-cleaner-article"
          >
            <h2
              id="video-metadata-cleaner-article"
            ...
            {ARTICLE_SECTIONS.map((section) => {
              ...
              return (
                <section
                  ...
                  aria-labelledby={`video-metadata-cleaner-article-${section}`}
                >
                  <h3
                    id={`video-metadata-cleaner-article-${section}`}

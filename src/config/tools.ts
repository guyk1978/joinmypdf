...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  { slug: "pdf-editor", labelKey: "pdfEditor", categories: [c.pdfEdit] },
  ...
  { slug: "url-parameter-stripper", labelKey: "urlParameterStripper", categories: [c.utilitiesEncoders] },
  ...
  { slug: "text-sanitizer", labelKey: "textSanitizer", categories: [c.utilitiesText] },
  ...
  { slug: "quick-note", labelKey: "quickNote", categories: [c.productivity] },

...
export const TOOL_REGISTRY = {
  ...
  Compress: ["pdf-compress", "compress-image", "video-compressor", "favicon-compressor"],
  Resize: [
    "resize-image",
    "crop-image",
    "rotate-image",
...
export const ALL_TOOLS_REGISTRY: AllToolsGroupConfig[] = [
  {
    ...
    columns: [
      ...
      },
      {
        ...
        slugs: columnSlugs(
          ["heic-to-jpg", "convert-to-png", "png-to-ico", "ico-to-png", "svg-to-favicon"],
          CONVERT_SLUGS,
        ),
      },
      {
    ...
    columns: [
      {
        ...
        slugs: columnSlugs(["resize-image", "crop-image", "rotate-image"], TOOL_REGISTRY.Resize),
      },
      {
        id: "pdf",
        labelKey: "megaMenu.columns.pdf",

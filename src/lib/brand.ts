...
/** Header / splash wordmark with spaced Title Case. */
export const BRAND_WORDMARK_EN = "Join My PDF";
...
/** Visible logo wordmark (spaced for English). */
export function getBrandWordmark(locale?: string): string {
  return locale === "he" ? BRAND_NAME_HE : BRAND_WORDMARK_EN;
}
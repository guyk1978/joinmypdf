...
const AUDIO_RELATED_TOOLS: Record<string, string[]> = {
  "mp3-converter": ["mp3-trimmer", "mp3-volume-booster", "wav-to-mp3"],
  "mp3-trimmer": ["mp3-converter", "mp3-volume-booster", "mp3-to-wav"],
  "mp3-volume-booster": ["mp3-converter", "mp3-trimmer", "mp3-compressor"],
  ...
  "mp3-speed-changer": ["mp3-trimmer", "mp3-volume-booster", "mp3-compressor"],
  "fade-in-out-creator": ["mp3-trimmer", "audio-merger", "mp3-volume-booster"],
  "audio-normalizer": ["mp3-volume-booster", "audio-merger", "mp3-compressor"],

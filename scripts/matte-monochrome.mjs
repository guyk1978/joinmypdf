...
const REPLACEMENTS = [
  ...
  [/\bdark:shadow-\[[^\]]+\]/g, ""],
  [/\bshadow-\[[^\]]+\]/g, ""],
  // Pass 3: slate/indigo elimination, strict contrast, density
  [/\bborder-slate-[^\s"'`]+/g, "border-neutral-300 dark:border-neutral-800"],
  [/\bbg-slate-[^\s"'`]+/g, "bg-neutral-200 dark:bg-neutral-900"],
  [/\bdark:bg-slate-[^\s"'`]+/g, "dark:bg-neutral-900"],
  [/\bdark:border-slate-[^\s"'`]+/g, "dark:border-neutral-800"],
  [/\btext-slate-[^\s"'`]+/g, "text-black dark:text-neutral-200"],
  [/\bdark:text-slate-[^\s"'`]+/g, "dark:text-neutral-200"],
  [/\bring-slate-[^\s"'`]+/g, "ring-neutral-300 dark:ring-neutral-700"],
  [/\bto-indigo-[^\s"'`]+/g, ""],
  [/\bfrom-indigo-[^\s"'`]+/g, ""],
  [/\bbg-indigo-[^\s"'`]+/g, "bg-neutral-800 dark:bg-neutral-700"],
  [/\bring-indigo-[^\s"'`]+/g, "ring-neutral-300 dark:ring-neutral-700"],
  [/\bborder-indigo-[^\s"'`]+/g, "border-neutral-300 dark:border-neutral-800"],
  [/\bhover:bg-slate-[^\s"'`]+/g, "hover:bg-neutral-300 dark:hover:bg-neutral-800"],
  [/\btext-neutral-800 dark:text-neutral-400\b/g, "text-black dark:text-neutral-200"],
  [/\btext-neutral-700 dark:text-neutral-400\b/g, "text-black dark:text-neutral-200"],
  [/\btext-neutral-800 dark:text-neutral-300\b/g, "text-black dark:text-neutral-200"],
  [/\btext-neutral-700 dark:text-neutral-300\b/g, "text-black dark:text-neutral-200"],
  [/\bdark:text-neutral-400\b/g, "dark:text-neutral-200"],
  [/\bdark:text-neutral-300\b/g, "dark:text-neutral-200"],
  [/\btext-neutral-800\b/g, "text-black"],
  [/\btext-neutral-700\b/g, "text-black"],
  [/\bdark: dark:/g, "dark:"],
  [/\s+dark:\s*"/g, ' "'],
  [/\s+dark:\s*`/g, " `"],
  [/\bgap-4\b/g, "gap-2"],

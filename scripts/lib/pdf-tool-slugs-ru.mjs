/**
 * Russian SEO slugs for PDF + video tools — keep in sync with src/lib/locale-tool-slugs.ts
 */
export const PDF_TOOL_SLUGS_RU = {
...
export const VIDEO_TOOL_SLUGS_RU = {
...
export const CONVERT_TOOL_SLUGS_RU = {
...
export const COMPRESS_TOOL_SLUGS_RU = {
...
export const MP4_TOOL_SLUGS_RU = {
  "mp4-to-mp3": "mp4-v-mp3",
  "video-compressor": "szhatie-mp4",
  "video-converter": "konverter-video",
  "video-metadata-cleaner": "ochistka-metadannykh-video",
...
export const EXTRACT_TOOL_SLUGS_RU = {
  "extract-images": "izvlech-izobrazheniya-iz-pdf",
  "extract-pdf-pages": "izvlech-stranitsy-pdf",
  "extract-tables-pdf": "izvlech-tablitsy-iz-pdf",
  "pdf-to-excel": "pdf-v-excel",
...
export const IMAGE_TOOL_SLUGS_RU = {
...
/** JPG hub — same IDs as convert/compress/image; kept explicit for category-first nests. */
export const JPG_TOOL_SLUGS_RU = {
  "compress-image": "szhatie-izobrazheniy",
  "heic-to-jpg": "heic-v-jpg",
  "jpg-to-pdf": "jpg-v-pdf",
  "pdf-to-jpg": "pdf-v-jpg",
...
/** PNG hub — category-first nests; optimizer shares image-tools slug. */
export const PNG_TOOL_SLUGS_RU = {
  "convert-to-png": "konverter-v-png",
  "ico-to-png": "ico-v-png",
  "image-optimizer": "optimizatsiya-izobrazheniy",
  "pdf-to-png": "pdf-v-png",
...
/** MP3 hub — aligned with MP4 (obrezka / skorost / szhatie). */
export const MP3_TOOL_SLUGS_RU = {
  "audio-compressor": "szhatie-audio",
...
/** Favicon hub — category-first nests. */
export const FAVICON_TOOL_SLUGS_RU = {
...
/** Text hub — category-first nests. */
export const TEXT_TOOL_SLUGS_RU = {
...
/** JSON hub — category-first nests. */
export const JSON_TOOL_SLUGS_RU = {
  "csv-to-json": "csv-v-json",
  "html-markdown-converter": "html-markdown-konverter",
  "json-csv-explorer": "issledovatel-json-csv",
...
/** Developer hub — category-first nests (+ security peers). */
export const DEVELOPER_TOOL_SLUGS_RU = {
...
/** Word hub — category-first nests. */
export const WORD_TOOL_SLUGS_RU = {
  "password-generator": "generator-paroley",
  "pdf-password-recovery": "vosstanovlenie-parolya-pdf",
  "pdf-to-word": "pdf-v-word",
  "word-character-counter": "schetchik-slov",
...
/** Excel hub — category-first nests. */
export const EXCEL_TOOL_SLUGS_RU = {
  "excel-to-pdf": "excel-v-pdf",
  "extract-tables-pdf": "izvlech-tablitsy-iz-pdf",
  "pdf-to-excel": "pdf-v-excel",
};

/** Crop hub — category-first nests. */
export const CROP_TOOL_SLUGS_RU = {
  "crop-image": "obrezka-izobrazheniya",
  "crop-pdf": "obrezka-pdf",
  "favicon-cropper": "obrezka-favicon",
};

/** Rotate hub — category-first nests. */
export const ROTATE_TOOL_SLUGS_RU = {
  "flip-image": "otrazhenie-izobrazheniya",
  "rotate-image": "povorot-izobrazheniya",
  "rotate-pdf": "povorot-pdf",
  "video-rotator": "povorot-video",
...
/** Security hub — category-first nests. */
export const SECURITY_TOOL_SLUGS_RU = {
  "hash-generator": "generator-khesha",
  "image-blur-redact": "razmytie-izobrazheniya",
  "image-metadata-wiper": "udalit-metadannye-izobrazheniya",
  "password-generator": "generator-paroley",
...
/** Data conversion hub — category-first nests. */
export const DATA_CONVERSION_TOOL_SLUGS_RU = {
  "csv-to-markdown-table": "csv-v-markdown",
  "sql-query-formatter": "formatirovanie-sql",
  "yaml-json-converter": "yaml-json-konverter",
};

/** Productivity hub — category-first nests. */
export const PRODUCTIVITY_TOOL_SLUGS_RU = {
  "base-converter": "konverter-sistem-schisleniya",
  "case-converter": "preobrazovatel-registra",
...
/** Unit converters hub — category-first nests. */
export const UNIT_MATH_TOOL_SLUGS_RU = {
  "base-converter": "konverter-sistem-schisleniya",
  "global-timezone-converter": "globalnyi-konverter-chasovyh-poyasov",
  "storage-data-converter": "konverter-edinits-hraneniya",
  "timezone-converter": "konverter-chasovyh-poyasov",
...
/** Network hub — category-first nests. */
export const NETWORK_TOOL_SLUGS_RU = {
  "jwt-debugger": "dekoder-jwt",
  "my-ip": "moy-ip",
  "ssl-decoder": "dekoder-ssl",
  "url-encoder-decoder": "url-kodirovshik",
...
export function localizeToolSlugForLocale(canonicalSlug, locale) {
  if (locale === "ru") return TOOL_SLUGS_RU[canonicalSlug] || canonicalSlug;
  return canonicalSlug;
}

export function resolveCanonicalToolSlugFromRu(slug) {
  for (const [id, ruSlug] of Object.entries(TOOL_SLUGS_RU)) {
    if (ruSlug === slug) return id;
  }
  return slug;
}
